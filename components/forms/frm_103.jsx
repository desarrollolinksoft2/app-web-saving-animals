    ...
    <>
      <div className="d-sm-contents">
        <div className="o_cell o_wrap_label">
          <label className="o_form_label">Nombre de etiqueta</label>
        </div>
        ...
        <div className="o_cell" >
          <div className="o_field">
                ...
                return (
                  ...
                  /> */}
                    ...
                    <Stack hidden={openPopup}>
                      <div class="o_colorlist d-flex flex-wrap align-items-center mw-100 gap-2">
                        ...
                        <button
                          ...
                          // Ref={field.ref}
                          // checked={field.value}
                          // data-color={field.value ? field.value : ""}
                    ...
                    {openPopup && (
                      <ClickAwayListener onClickAway={handleBlur}>
                        ...
                        >
                          ...
                          <div ref={colorOptionsRef} class="o_colorlist d-flex flex-wrap align-items-center mw-100 gap-2">
                              ...
                              return (
                                <>
                                  <button
                                    ...
                                    className={`btn p-0 rounded-0 o_colorlist_item_color_${option.value
            ...
            {/* 
                <button
                  type="button"
                  className={`btn p-0 rounded-0 o_colorlist_toggler o_colorlist_item_color_${color}`}
                  // onClick={(e) => fn_click(e, option)}
                  // onClick={fn_click}
                  onClick={fn_click2}
                ></button> */}
